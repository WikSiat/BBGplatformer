...
public class MapGeneratorButton extends Button {
	...
	public MapGeneratorButton(IClickCallback callback) {
		super(new ButtonStyle());
		init(callback);
	}

	private void init(final IClickCallback callback) {
		clickSound = Gdx.audio.newSound(Gdx.files.internal("startSound.ogg")); //TODO change click sound
